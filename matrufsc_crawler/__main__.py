...
def crawl(campus: Campus, semester: str, send_queue: Queue):
...
def parse(campus: Campus, semester: str, receive_queue: Queue, output: dict):
...
def run(campus: Campus, semester: str, outputs: dict):
    label = f'runner_{campus.name}_{semester}'
...
def main():
    ...
    semesters = available_semesters(logger)[:2]
